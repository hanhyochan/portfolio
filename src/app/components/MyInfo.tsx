...
const MyInfo = () => {
  return (
    <div className="mt-[5rem] w-full h-[30rem] bg-neutral-200 rounded-[2rem] flex justify-between p-[3rem] gap-[3rem]">
      ...
      <Image src="/images/profile.jpg" alt="profile" width={500} height={100} />
    </div>
  );
};
