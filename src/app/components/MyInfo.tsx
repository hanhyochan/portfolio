...
// const MyInfo = () => {
//   return (
//     <div className="mt-[5rem] w-full h-[30rem] bg-neutral-200 rounded-[2rem] flex justify-between p-[3rem] gap-[3rem] relative">
...
//         </div>
//       </div>
//       <div className="absolute top-0 right-0 w-[calc(50%+10rem)] h-full overflow-hidden z-1">
...
//             layout="fill"
//             objectFit="cover"
//             className="filter grayscale-[100%] opacity-50"
//           />
//         </div>
//       </div>
//     </div>
...
const MyInfo = () => {
  return (
    <div className="mt-[5rem] w-full h-[30rem] bg-neutral-100 rounded-[0.5rem] grid grid-cols-2 gap-[3rem]">
      <div className="flex flex-col justify-between p-[3rem]">
        <div className="flex flex-col gap-[2rem]">
          ...
          <div className="flex flex-col gap-[0.5rem] text-lg">
            <div className="bg-neutral-200 rounded-[0.5rem] flex gap-[1rem] items-center px-[1.5rem] py-[1rem]">
              <Image
